...
<p><br>2. I have always liked math and science classes <br>best and I do well in them.</p>
...
<p><br>
6. I love being outdoors and enjoy spending <br>my free time outside.</p>
...
<p><br>
7. I have some important goals for my life <br>that I think about often.</p>
...
<p><br>
9. I like English, social studies and history <br>better than math and science.</p>
...
<p><br>
10. I like to figure out how to take apart <br>and put back together things <br>like toys and puzzles.</p>
...
<p><br>
11.  I try to look for patterns and regularities in things,<br> such as every third  stair on the staircase has a notch<br> in it.</p>
...
<p><br>
12. I have good skills in one or more sports and <br>learn new sports quickly.</p>
...
<p><br>
13. I frequently listen to music because I enjoy it<br> so much.</p>
...
<p><br>
16. I enjoy watching nature shows on television like the<br> Discovery Channel,National Geographic and Nova.</p>
...
<p><br>
18. I enjoy playing around with a chemistry set and<br> am interested in new discoveries in science.</p>
...
<p><br>
19. When I watch a movie or  video, I am more<br> interested in what I see than what I hear.</p>
...
<p><br>
20. Sometimes when I talk with people,<br> I gesture with my hands.</p>
...
<p><br>
22. I am an active person and if I can’t move around<br>I get bored.</p>
...
<p><br>
24. It’s fun to watch birds or other animals,<br> to watch their habits, plants and flowers,and to learn <br> more about them.</p>
...
<p><br>
26. I believe that almost everything has a logical<br> explanation.</p>
...
<p><br>
27. When I close my eyes, sometimes I can see clear <br> images in my  head that seem real.</p>
...
<p><br>
31. I like to spend time alone thinking about things<br> that are important to me. </p>
...
<p><br>
32.  I’m very good at telling the difference between<br> different kinds of  birds, dogs, trees and stuff like that.</p>
...
<p><br>
34. I like to play games and solve brainteasers <br>that require tactics and strategy.</p>
...
<p><br>
35. I am good at reading maps and finding my way<br> around unfamiliar place.</p>
...
<p><br>
36. I like working with my hands in activities such as <br>sewing, carving, or model building.</p>
...
<p><br>
37.  Sometimes I catch myself walking along with a <br>television jingle or song in my mind.</p>
...
<p><br>
39. I think I know what I am good at and what <br>I’m not so good at doing.</p>
...
<p><br>
40. I enjoy visiting zoos, natural history museums or<br> other places where the world is studied.</p>
...
<div><img id="image1" style="position: absolute; display: none; top: 80px;width: 600px;" src="linguisticImage.png"></div>
<div><img id="image2" style="position: absolute; display: none; top: 80px;width: 600px;" src="mathImage.png"></div>
<div><img id="image3" style="position: absolute; display: none; top: 80px;width: 600px;" src="visualImage.png"></div>
<div><img id="image4" style="position: absolute; display: none; top: 80px;width: 600px;" src="bodyImage.png"></div>
<div><img id="image5" style="position: absolute; display: none; top: 80px;width: 600px;" src="musicalImage.png"></div>
<div><img id="image6" style="position: absolute; display: none; top: 80px;width: 600px;" src="interImage.png"></div>
<div><img id="image7" style="position: absolute; display: none; top: 80px;width: 600px;" src="intraImage.png"></div>
<div><img id="image8" style="position: absolute; display: none; top: 80px;width: 600px;" src="natImage.png"></div>
...
<div style="position:absolute;border: 2px solid chocolate;left:130px;bottom: 860px;height: 30px; width: 30px; background-color: Thistle ;">
  <p id="multilabel">Linguistic</p>
   </div>
<div style="position:absolute;border: 2px solid chocolate;left:130px;bottom: 820px;height: 30px; width: 30px; background-color: Plum;">
    <p id="multilabel2">Mathematical/Logical</p></div>
<div style="position:absolute;border: 2px solid chocolate;left:130px;bottom: 780px;height: 30px; width: 30px; background-color: Orchid;">
    <p id="multilabel3">Visual/Spatial</p></div>
<div style="position:absolute;border: 2px solid chocolate;left:130px;bottom: 740px;height: 30px; width: 30px; background-color: Violet;">
    <p id="multilabel4">BodilyKinesthetic</p></div>
<div style="position:absolute;border: 2px solid chocolate;left:130px;bottom: 700px;height: 30px; width: 30px; background-color: Fuchsia;">
    <p id="multilabel5">Musical</p></div>
<div style="position:absolute;border: 2px solid chocolate;left:130px;bottom: 660px;height: 30px; width: 30px; background-color: mediumorchid;">
    <p id="multilabel6">Interpersonal</p></div>
<div style="position:absolute;border: 2px solid chocolate;left:130px;bottom: 620px;height: 30px; width: 30px; background-color: mediumslateblue;">
    <p id="multilabel7">Intrapersonal</p></div>
<div style="position:absolute;border: 2px solid chocolate;left:130px;bottom: 580px;height: 30px; width: 30px; background-color: slateblue;">
    <p id="multilabel8">Naturalist</p></div>
</div>

<p id="demo2" style="position: fixed;top: 46%; left: 55%; font-size: 40px;font-weight: bold;"></p>
