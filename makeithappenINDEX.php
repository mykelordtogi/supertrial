...
.menu-toggler:checked ~ ul .menu-item:nth-child(2) {
  transform: rotate(60deg) translate(-20px) translateX(-150px) translateY(20px);
...
.menu-toggler:checked ~ ul .menu-item:nth-child(3) {
  transform: rotate(120deg) translate(-20px) translateX(-160px) translateY(-40px);
  

}
.menu-toggler:checked ~ ul .menu-item:nth-child(4) {
  transform: rotate(180deg) translateX(-220px) translateY(0px);
  
}
.menu-toggler:checked ~ ul .menu-item:nth-child(5) {
  transform: rotate(240deg) translateX(-180px) translateY(60px);
}
.menu-toggler:checked ~ ul .menu-item:nth-child(6) {
  transform: rotate(300deg) translateX(-170px) translateY(-40px);
}
...
background-color: black;
    color: white;
text-align: center;
    margin-left: -135px; /* moves the tooltip to the right */
...
transform: rotate(-59.8deg) translateX(-130px) translateY(10px);
    position: absolute;
    z-index: 1000;
}
...
background-color: black;
    color: white;
 text-align: center;
transform: rotate(-120deg) translateX(130px) translateY(-30px);
    position: absolute;
    z-index: 1000;
}
...
background-color: black;
    color: white;
 text-align: center;
transform: rotate(180deg) translateX(110px) translateY(80px);
    position: absolute;
    z-index: 1000;
}
...
transform: rotate(120deg) translateX(20px) translateY(70px);
    position: absolute;
    z-index: 1000;
}
...
background-color: black;
    color: white;
 text-align: center;
transform: rotate(60deg) translateX(5px) translateY(110px);
    position: absolute;
    z-index: 1000;
}
...
background-color: black;
  color: white;
text-align: center;
transform: rotate(60deg) translateX(120px) translateY(40px);
  position: absolute;
  z-index: 1000;
}
...
<nav class="menu">
  <input checked="checked" class="menu-toggler" type="checkbox" style="position: absolute; left: 700px;">
  <label for="menu-toggler"> <img id="silman" src="standing.png" style="position: absolute; left: 700px; top: 25%; height: 300px;"></label>
  <ul>
